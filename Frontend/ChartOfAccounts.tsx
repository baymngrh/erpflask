...
const ChartOfAccounts = () => {
  ...
  const handleEditAccount = (account: Account) => {
    ...
    alert(`Edit Account: ${account.name}\nCode: ${account.code}\nType: ${account.type}\nBalance: ${formatRupiah(account.balance)}`)
  }
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            ...
            >
              <div>
                ...
                <input type="text" className="input w-full" placeholder="e.g., 1000" required />
              </div>
              ...
              <div>
                ...
                <input type="text" className="input w-full" placeholder="e.g., Cash in Bank" />
              </div>
