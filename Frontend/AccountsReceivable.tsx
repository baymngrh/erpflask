          ...
          <div className="flex gap-2">
            ...
            <button 
              onClick={() => {
                ...
                console.log('Exporting AR data:', data)
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button 
                        onClick={() => {
                          ...
                          console.log('Record payment for invoice:', receivable.invoice_number)
                          alert(`Recording payment for ${receivable.invoice_number}. This will redirect to payment form.`)
                        }}
                      ...
                      <button 
                        onClick={() => {
                          if (window.confirm(`Are you sure you want to delete invoice ${receivable.invoice_number}?`)) {
                            ...
                            console.log('Delete invoice:', receivable.id)
                            alert(`Invoice ${receivable.invoice_number} would be deleted from the system.`)
                          }
                        }}
