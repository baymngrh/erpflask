...
from models import db, Customer, SalesOrder, SalesOrderItem, SalesForecast, Product
...
def create_order():
    ...
    try:
        ...
        return jsonify({'message': 'Order created', 'order_id': order.id, 'order_number': order_number}), 201
    except Exception as e:
        db.session.rollback()
        return jsonify({'error': str(e)}), 500
